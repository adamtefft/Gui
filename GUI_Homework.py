...
class myGUI:
    ...
    def __init__(self):
        ...
        self.main_text = tkinter.Label(self.email_frame, text='Responsive Registration\nForm\n', font = ("Bold", 22))
        ...
        self.password_entry = tkinter.Entry(self.password_frame, show="*", width=30)
        self.password_entry.pack(side = 'right')

        self.password2_label = tkinter.Label(self.password2_frame, text='Retype Password:')
        self.password2_label.pack(side='left')        

        self.password2_entry = tkinter.Entry(self.password2_frame, show="*", width=25)
        ...
        self.fname_entry = tkinter.Entry(self.name_frame, width=9)
        self.fname_entry.pack(side = 'left')

        self.lname_entry = tkinter.Entry(self.name_frame, width=9)
        ...
        self.radiobutton1 = tkinter.Radiobutton(self.rb_frame, variable=self.radio_var, text='Male', value=True)
        self.radiobutton1.pack(side='left')

        self.radiobutton2 = tkinter.Radiobutton(self.rb_frame, variable=self.radio_var, text='Female', value=True)
        ...
        self.confirmationbutton = tkinter.Button(self.main_window, text = "Register", command=self.check_credentials)
